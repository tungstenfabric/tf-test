...
class ContrailFeatureFlag(contrail.ContrailResource):
    PROPERTIES = (
        NAME, FQ_NAME, DISPLAY_NAME, FEATURE_FLAG_VERSION, PERMS2, PERMS2_OWNER, PERMS2_OWNER_ACCESS, PERMS2_GLOBAL_ACCESS, PERMS2_SHARE, PERMS2_SHARE_TENANT, PERMS2_SHARE_TENANT_ACCESS, FEATURE_RELEASE, FEATURE_ID, FEATURE_STATE, ID_PERMS, ID_PERMS_PERMISSIONS, ID_PERMS_PERMISSIONS_OWNER, ID_PERMS_PERMISSIONS_OWNER_ACCESS, ID_PERMS_PERMISSIONS_GROUP, ID_PERMS_PERMISSIONS_GROUP_ACCESS, ID_PERMS_PERMISSIONS_OTHER_ACCESS, ID_PERMS_UUID, ID_PERMS_UUID_UUID_MSLONG, ID_PERMS_UUID_UUID_LSLONG, ID_PERMS_ENABLE, ID_PERMS_CREATED, ID_PERMS_LAST_MODIFIED, ID_PERMS_DESCRIPTION, ID_PERMS_USER_VISIBLE, ID_PERMS_CREATOR, ENABLE_FEATURE, ANNOTATIONS, ANNOTATIONS_KEY_VALUE_PAIR, ANNOTATIONS_KEY_VALUE_PAIR_KEY, ANNOTATIONS_KEY_VALUE_PAIR_VALUE, FEATURE_DESCRIPTION, TAG_REFS, GLOBAL_SYSTEM_CONFIG
    ) = (
        'name', 'fq_name', 'display_name', 'feature_flag_version', 'perms2', 'perms2_owner', 'perms2_owner_access', 'perms2_global_access', 'perms2_share', 'perms2_share_tenant', 'perms2_share_tenant_access', 'feature_release', 'feature_id', 'feature_state', 'id_perms', 'id_perms_permissions', 'id_perms_permissions_owner', 'id_perms_permissions_owner_access', 'id_perms_permissions_group', 'id_perms_permissions_group_access', 'id_perms_permissions_other_access', 'id_perms_uuid', 'id_perms_uuid_uuid_mslong', 'id_perms_uuid_uuid_lslong', 'id_perms_enable', 'id_perms_created', 'id_perms_last_modified', 'id_perms_description', 'id_perms_user_visible', 'id_perms_creator', 'enable_feature', 'annotations', 'annotations_key_value_pair', 'annotations_key_value_pair_key', 'annotations_key_value_pair_value', 'feature_description', 'tag_refs', 'global_system_config'
    )
    ...
    properties_schema = {
        ...
        FEATURE_FLAG_VERSION: properties.Schema(
            properties.Schema.STRING,
        ...
        FEATURE_RELEASE: properties.Schema(
            properties.Schema.STRING,
            _('FEATURE_RELEASE.'),
            update_allowed=True,
            required=False,
        ),
        FEATURE_ID: properties.Schema(
            properties.Schema.STRING,
            _('FEATURE_ID.'),
            update_allowed=True,
            required=False,
        ),
        FEATURE_STATE: properties.Schema(
            properties.Schema.STRING,
            _('FEATURE_STATE.'),
            update_allowed=True,
            required=False,
        ...
        ENABLE_FEATURE: properties.Schema(
            properties.Schema.BOOLEAN,
            _('ENABLE_FEATURE.'),
            update_allowed=True,
            required=False,
        ...
        FEATURE_DESCRIPTION: properties.Schema(
            properties.Schema.STRING,
    ...
    attributes_schema = {
        ...
        FEATURE_FLAG_VERSION: attributes.Schema(
            _('FEATURE_FLAG_VERSION.'),
        ),
        PERMS2: attributes.Schema(
            _('PERMS2.'),
        ),
        FEATURE_RELEASE: attributes.Schema(
            _('FEATURE_RELEASE.'),
        ),
        FEATURE_ID: attributes.Schema(
            _('FEATURE_ID.'),
        ),
        FEATURE_STATE: attributes.Schema(
            _('FEATURE_STATE.'),
        ),
        ID_PERMS: attributes.Schema(
            _('ID_PERMS.'),
        ),
        ENABLE_FEATURE: attributes.Schema(
            _('ENABLE_FEATURE.'),
        ),
        ANNOTATIONS: attributes.Schema(
            _('ANNOTATIONS.'),
        ),
        FEATURE_DESCRIPTION: attributes.Schema(
            _('FEATURE_DESCRIPTION.'),
        ),
    ...
    def handle_create(self):
        ...
        obj_0 = vnc_api.FeatureFlag(name=self.properties[self.NAME],
            parent_obj=parent_obj)

        if self.properties.get(self.DISPLAY_NAME) is not None:
            obj_0.set_display_name(self.properties.get(self.DISPLAY_NAME))
        if self.properties.get(self.FEATURE_FLAG_VERSION) is not None:
            obj_0.set_feature_flag_version(self.properties.get(self.FEATURE_FLAG_VERSION))
        ...
        if self.properties.get(self.FEATURE_RELEASE) is not None:
            obj_0.set_feature_release(self.properties.get(self.FEATURE_RELEASE))
        if self.properties.get(self.FEATURE_ID) is not None:
            obj_0.set_feature_id(self.properties.get(self.FEATURE_ID))
        if self.properties.get(self.FEATURE_STATE) is not None:
            obj_0.set_feature_state(self.properties.get(self.FEATURE_STATE))
        ...
        if self.properties.get(self.ENABLE_FEATURE) is not None:
            obj_0.set_enable_feature(self.properties.get(self.ENABLE_FEATURE))
        ...
        if self.properties.get(self.FEATURE_DESCRIPTION) is not None:
            obj_0.set_feature_description(self.properties.get(self.FEATURE_DESCRIPTION))
        ...
        try:
            obj_uuid = super(ContrailFeatureFlag, self).resource_create(obj_0)
        except Exception as e:
            raise Exception(_('%s') % str(e))
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        try:
            obj_0 = self.vnc_lib().feature_flag_read(
                id=self.resource_id
            )
        except Exception as e:
            raise Exception(_('%s') % str(e))
        ...
        if prop_diff.get(self.FEATURE_FLAG_VERSION) is not None:
            obj_0.set_feature_flag_version(prop_diff.get(self.FEATURE_FLAG_VERSION))
        if prop_diff.get(self.FEATURE_ID) is not None:
            obj_0.set_feature_id(prop_diff.get(self.FEATURE_ID))
        if prop_diff.get(self.ENABLE_FEATURE) is not None:
            obj_0.set_enable_feature(prop_diff.get(self.ENABLE_FEATURE))
        ...
        try:
            self.vnc_lib().feature_flag_update(obj_0)
        except Exception as e:
            raise Exception(_('%s') % str(e))
    ...
    def handle_delete(self):
        ...
        try:
            self.vnc_lib().feature_flag_delete(id=self.resource_id)
        except Exception as ex:
            self._ignore_not_found(ex)
            LOG.warn(_('feature_flag %s already deleted.') % self.name)

    @contrail.set_auth_token
    def _show_resource(self):
        obj = self.vnc_lib().feature_flag_read(id=self.resource_id)
...
def resource_mapping():
    return {
        'OS::ContrailV2::FeatureFlag': ContrailFeatureFlag,
    }
