...
class ContrailVirtualIp(contrail.ContrailResource):
    PROPERTIES = (
        NAME, FQ_NAME, DISPLAY_NAME, ID_PERMS, ID_PERMS_PERMISSIONS, ID_PERMS_PERMISSIONS_OWNER, ID_PERMS_PERMISSIONS_OWNER_ACCESS, ID_PERMS_PERMISSIONS_GROUP, ID_PERMS_PERMISSIONS_GROUP_ACCESS, ID_PERMS_PERMISSIONS_OTHER_ACCESS, ID_PERMS_UUID, ID_PERMS_UUID_UUID_MSLONG, ID_PERMS_UUID_UUID_LSLONG, ID_PERMS_ENABLE, ID_PERMS_CREATED, ID_PERMS_LAST_MODIFIED, ID_PERMS_DESCRIPTION, ID_PERMS_USER_VISIBLE, ID_PERMS_CREATOR, VIRTUAL_IP_PROPERTIES, VIRTUAL_IP_PROPERTIES_ADDRESS, VIRTUAL_IP_PROPERTIES_STATUS, VIRTUAL_IP_PROPERTIES_STATUS_DESCRIPTION, VIRTUAL_IP_PROPERTIES_ADMIN_STATE, VIRTUAL_IP_PROPERTIES_PROTOCOL, VIRTUAL_IP_PROPERTIES_PROTOCOL_PORT, VIRTUAL_IP_PROPERTIES_CONNECTION_LIMIT, VIRTUAL_IP_PROPERTIES_SUBNET_ID, VIRTUAL_IP_PROPERTIES_PERSISTENCE_COOKIE_NAME, VIRTUAL_IP_PROPERTIES_PERSISTENCE_TYPE, ANNOTATIONS, ANNOTATIONS_KEY_VALUE_PAIR, ANNOTATIONS_KEY_VALUE_PAIR_KEY, ANNOTATIONS_KEY_VALUE_PAIR_VALUE, PERMS2, PERMS2_OWNER, PERMS2_OWNER_ACCESS, PERMS2_GLOBAL_ACCESS, PERMS2_SHARE, PERMS2_SHARE_TENANT, PERMS2_SHARE_TENANT_ACCESS, TAG_REFS, VIRTUAL_MACHINE_INTERFACE_REFS, LOADBALANCER_POOL_REFS, PROJECT
    ) = (
        'name', 'fq_name', 'display_name', 'id_perms', 'id_perms_permissions', 'id_perms_permissions_owner', 'id_perms_permissions_owner_access', 'id_perms_permissions_group', 'id_perms_permissions_group_access', 'id_perms_permissions_other_access', 'id_perms_uuid', 'id_perms_uuid_uuid_mslong', 'id_perms_uuid_uuid_lslong', 'id_perms_enable', 'id_perms_created', 'id_perms_last_modified', 'id_perms_description', 'id_perms_user_visible', 'id_perms_creator', 'virtual_ip_properties', 'virtual_ip_properties_address', 'virtual_ip_properties_status', 'virtual_ip_properties_status_description', 'virtual_ip_properties_admin_state', 'virtual_ip_properties_protocol', 'virtual_ip_properties_protocol_port', 'virtual_ip_properties_connection_limit', 'virtual_ip_properties_subnet_id', 'virtual_ip_properties_persistence_cookie_name', 'virtual_ip_properties_persistence_type', 'annotations', 'annotations_key_value_pair', 'annotations_key_value_pair_key', 'annotations_key_value_pair_value', 'perms2', 'perms2_owner', 'perms2_owner_access', 'perms2_global_access', 'perms2_share', 'perms2_share_tenant', 'perms2_share_tenant_access', 'tag_refs', 'virtual_machine_interface_refs', 'loadbalancer_pool_refs', 'project'
    )
