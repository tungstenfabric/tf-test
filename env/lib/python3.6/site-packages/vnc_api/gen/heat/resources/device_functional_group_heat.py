...
class ContrailDeviceFunctionalGroup(contrail.ContrailResource):
    ...
    properties_schema = {
        ...
        DEVICE_FUNCTIONAL_GROUP_OS_VERSION: properties.Schema(
            properties.Schema.STRING,
            _('DEVICE_FUNCTIONAL_GROUP_OS_VERSION.'),
            update_allowed=True,
            required=False,
        ),
        DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES: properties.Schema(
            properties.Schema.MAP,
            _('DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES.'),
            update_allowed=True,
            required=False,
            schema={
                DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES_RB_ROLES: properties.Schema(
                    properties.Schema.LIST,
                    _('DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES_RB_ROLES.'),
                    update_allowed=True,
                    required=False,
                ),
            }
        ...
        DEVICE_FUNCTIONAL_GROUP_DESCRIPTION: properties.Schema(
            properties.Schema.STRING,
            _('DEVICE_FUNCTIONAL_GROUP_DESCRIPTION.'),
            update_allowed=True,
            required=False,
        ),
    ...
    attributes_schema = {
        ...
        DEVICE_FUNCTIONAL_GROUP_OS_VERSION: attributes.Schema(
            _('DEVICE_FUNCTIONAL_GROUP_OS_VERSION.'),
        ),
        DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES: attributes.Schema(
            _('DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES.'),
        ),
        ...
        DEVICE_FUNCTIONAL_GROUP_DESCRIPTION: attributes.Schema(
            _('DEVICE_FUNCTIONAL_GROUP_DESCRIPTION.'),
        ),
    ...
    def handle_create(self):
        ...
        obj_0 = vnc_api.DeviceFunctionalGroup(name=self.properties[self.NAME],
            parent_obj=parent_obj)

        if self.properties.get(self.DEVICE_FUNCTIONAL_GROUP_OS_VERSION) is not None:
            obj_0.set_device_functional_group_os_version(self.properties.get(self.DEVICE_FUNCTIONAL_GROUP_OS_VERSION))
        if self.properties.get(self.DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES) is not None:
            obj_1 = vnc_api.RoutingBridgingRolesType()
            if self.properties.get(self.DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES, {}).get(self.DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES_RB_ROLES) is not None:
                for index_1 in range(len(self.properties.get(self.DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES, {}).get(self.DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES_RB_ROLES))):
                    obj_1.add_rb_roles(self.properties.get(self.DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES, {}).get(self.DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES_RB_ROLES)[index_1])
            obj_0.set_device_functional_group_routing_bridging_roles(obj_1)
        ...
        if self.properties.get(self.DEVICE_FUNCTIONAL_GROUP_DESCRIPTION) is not None:
            obj_0.set_device_functional_group_description(self.properties.get(self.DEVICE_FUNCTIONAL_GROUP_DESCRIPTION))
        ...
        try:
            obj_uuid = super(ContrailDeviceFunctionalGroup, self).resource_create(obj_0)
        except Exception as e:
            raise Exception(_('%s') % str(e))
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        try:
            obj_0 = self.vnc_lib().device_functional_group_read(
                id=self.resource_id
            )
        except Exception as e:
            raise Exception(_('%s') % str(e))

        if prop_diff.get(self.DEVICE_FUNCTIONAL_GROUP_OS_VERSION) is not None:
            obj_0.set_device_functional_group_os_version(prop_diff.get(self.DEVICE_FUNCTIONAL_GROUP_OS_VERSION))
        if prop_diff.get(self.DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES) is not None:
            obj_1 = vnc_api.RoutingBridgingRolesType()
            if prop_diff.get(self.DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES, {}).get(self.DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES_RB_ROLES) is not None:
                for index_1 in range(len(prop_diff.get(self.DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES, {}).get(self.DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES_RB_ROLES))):
                    obj_1.add_rb_roles(prop_diff.get(self.DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES, {}).get(self.DEVICE_FUNCTIONAL_GROUP_ROUTING_BRIDGING_ROLES_RB_ROLES)[index_1])
            obj_0.set_device_functional_group_routing_bridging_roles(obj_1)
        ...
        if prop_diff.get(self.ANNOTATIONS) is not None:
            ...
            if prop_diff.get(self.ANNOTATIONS, {}).get(self.ANNOTATIONS_KEY_VALUE_PAIR) is not None:
                for index_1 in range(len(prop_diff.get(self.ANNOTATIONS, {}).get(self.ANNOTATIONS_KEY_VALUE_PAIR))):
                    ...
                    obj_1.add_key_value_pair(obj_2)
            obj_0.set_annotations(obj_1)
        if prop_diff.get(self.DEVICE_FUNCTIONAL_GROUP_DESCRIPTION) is not None:
            obj_0.set_device_functional_group_description(prop_diff.get(self.DEVICE_FUNCTIONAL_GROUP_DESCRIPTION))
        ...
        try:
            self.vnc_lib().device_functional_group_update(obj_0)
        except Exception as e:
            raise Exception(_('%s') % str(e))
    ...
    def handle_delete(self):
        ...
        try:
            self.vnc_lib().device_functional_group_delete(id=self.resource_id)
        except Exception as ex:
            self._ignore_not_found(ex)
            LOG.warn(_('device_functional_group %s already deleted.') % self.name)

    @contrail.set_auth_token
    def _show_resource(self):
        obj = self.vnc_lib().device_functional_group_read(id=self.resource_id)
...
def resource_mapping():
    return {
        'OS::ContrailV2::DeviceFunctionalGroup': ContrailDeviceFunctionalGroup,
    }
