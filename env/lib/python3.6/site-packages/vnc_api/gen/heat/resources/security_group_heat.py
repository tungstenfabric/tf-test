                        ...
                        schema={
                            ...
                            SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST: properties.Schema(
                                ...
                                schema={
                                    ...
                                    SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_HOST_BASED_SERVICE: properties.Schema(
                                        properties.Schema.BOOLEAN,
                                        _('SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_HOST_BASED_SERVICE.'),
                                        update_allowed=True,
                                        required=False,
                                    ),
                                }
            ...
            if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE) is not None:
                for index_1 in range(len(self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE))):
                    ...
                    if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST) is not None:
                        ...
                        if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_HOST_BASED_SERVICE) is not None:
                            obj_3.set_host_based_service(self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_HOST_BASED_SERVICE))
            ...
            if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE) is not None:
                for index_1 in range(len(prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE))):
                    ...
                    if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST) is not None:
                        ...
                        if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_HOST_BASED_SERVICE) is not None:
                            obj_3.set_host_based_service(prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_HOST_BASED_SERVICE))
                        obj_2.set_action_list(obj_3)
