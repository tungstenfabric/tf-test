...
class TestIpMacLearning(BaseVrouterTest,BaseVnVmTest, BaseHC):
    ...
    @preposttest_wrapper
    def test_enable_maciplearning_1(self):
        '''
        ...
        assert "MI" in flag , "Mac-ip learning flag is not enabled."

        return True
    # end test_enable_maciplearning_1
...
['mac']
    ...
    @test.attr(type=['suite1', 'upgrade','vrouter_gw', 'vcenter_compute', 'ci_contrail_go_kolla_ocata_sanity'])
    @preposttest_wrapper
    def test_dynamically_disable_maciplearningflag_18(self):
        '''
        ...
        cmd = ['ip link delete macvlan1']
        self.vm4_fixture.run_cmd_on_vm(cmd, as_sudo=True)
    # end test_dynamically_disable_maciplearningflag_18
