...
class TestFabricGDO(BaseFabricTest):
    ...
    def test_fabric_gdo_env_firmware(self):
        self.get_chassis_gdo_info(self.inputs.fabrics[0], gdo_type="chassis firmware")
    ...
    def test_fabric_gdo_env_temp(self):
        self.get_chassis_gdo_info(self.inputs.fabrics[0], gdo_type="chassis temperature-thresholds")
