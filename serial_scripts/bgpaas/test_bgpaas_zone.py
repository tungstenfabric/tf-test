...
class TestBGPaasZone(BaseBGPaaS):
    ...
    def basic_control_node_zone_setup(self):
        ...
        assert self.verify_bgpaas_in_control_nodes_and_agent(self.bgpaas_fixtures,self.vms)
    ...
    def test_bgp_control_node_zone(self):
        ...
        assert self.verify_bgpaas_in_control_nodes_and_agent(self.bgpaas_fixtures,self.vms)
        assert self.client_vm.ping_with_certainty(self.vip)
        assert self.verify_bgpaas_in_control_nodes_and_agent(self.bgpaas_fixtures,[self.vms[0]]) is not False
        return
    ...
    def test_bgp_multiple_control_nodes_in_zone(self):
        ...
        assert self.verify_bgpaas_in_control_nodes_and_agent(bgpaas_fixtures,vms)
